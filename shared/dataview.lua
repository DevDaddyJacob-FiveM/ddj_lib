-- ########################################################################################
-- ###                               Data View (dataview.lua)                           ###
-- ###     https://github.com/Demigod916/object_gizmo/blob/main/client/dataview.lua     ###
-- ########################################################################################

--[[
    Credits: https://github.com/Demigod916/object_gizmo
    Used under the GNU General Public License v3.0 (https://github.com/Demigod916/object_gizmo/blob/main/LICENSE)

    Contains some source code modifications.
