# DevDaddyJacob Library
A simple collection of common dependencies across all of my scripts

## Installation
Installing the resource is simple, just download the latest version from the [releases](https://github.com/DevDaddyJacob-FiveM/ddj_lib/releases/latest) tab, place the folder into your FiveM resources folder and then add `ensure ddj_lib` to your server.cfg file.
